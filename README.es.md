...
* **App móvil para clientes** ([Ionic 8](https://ionicframework.com) + Angular zoneless + Capacitor), con reserva de citas, selección de peluquero, pago con Stripe y login biométrico.
